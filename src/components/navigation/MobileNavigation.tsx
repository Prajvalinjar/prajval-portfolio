...
export const MobileNavigation: React.FC = React.memo(() => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[120] px-4 py-2.5 bg-[#030509]/95 border-b border-white/10 flex items-center justify-between pointer-events-auto">
        {/* Brand */}
